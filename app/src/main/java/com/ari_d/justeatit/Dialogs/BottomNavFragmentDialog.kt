...
@AndroidEntryPoint
class BottomNavFragmentDialog : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.chargeCard(
            args.amounToPay.toInt(),
            args.cardNumber,
            args.cardCvv.toInt(),
            args.cardExpiry.substring(0, 2).toInt(),
            args.cardExpiry.substring(2, 4).toInt(),
            requireActivity()
        )
    }
    ...
    private fun subsribeToObservers() {
        ...
        viewModel.chargeCardStatus.observe(viewLifecycleOwner, EventObserver(
            onError = {
